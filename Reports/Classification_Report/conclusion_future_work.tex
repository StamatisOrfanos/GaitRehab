...
This study presents a lightweight and effective machine learning framework for classifying abnormal gait signals using a small number of clinically meaningful 
features derived from gyroscope data. Among the models evaluated, Random Forest, XGBoost, and Logistic Regression achieved the best overall performance in terms 
of accuracy, F1-score, and AUC, demonstrating strong generalization capabilities and low misclassification rates. In contrast, SVM-based models exhibited lower 
sensitivity, particularly in detecting abnormal gait, highlighting the importance of model selection in clinical contexts. The findings emphasize that even with 
limited features and small datasets, robust classification is achievable through proper feature engineering and algorithm choice.
