...
Gait analysis, defined as the systematic study of human locomotion, offers critical insights into motor control, functional ability, and the presence of 
pathological deviations \citep{ref1, ref2}. While observational assessments are commonly used in clinical practice, they often lack the precision required 
...
assessments of motor asymmetry are crucial. Stroke survivors often experience **hemiparesis**, a condition that leads to asymmetrical gait 
...
is vital for tailoring rehabilitation programs, tracking recovery progress, and preventing secondary complications such as joint degeneration 
or falls \cite{ref6}, \cite{ref7}.
...
These sensors—such as **accelerometers and gyroscopes**—enable three-dimensional kinematic monitoring in naturalistic environments, offering 
an ideal platform for remote rehabilitation and real-time feedback \cite{ref11}, \cite{ref12}. Combined with modern **machine learning techniques**, wearable 
...
computational resources, or opaque feature extraction pipelines. Furthermore, there remains a lack of lightweight, interpretable methods specifically 
...
To address this gap, this work proposes a minimal-feature, machine learning-based pipeline for classifying normal versus abnormal gait patterns using 
...
* (i) the use of biomechanically relevant, low-dimensional gyroscope features for gait classification;
* (ii) a comparative evaluation of classic machine learning models using LOOCV on subject-level data; and
* (iii) a demonstration of the feasibility of deploying these models in real-time, wearable stroke rehabilitation settings.

The remainder of this paper is structured as follows: Section II reviews related work in wearable gait analysis and machine learning classification. 
Section III details the dataset, feature engineering, and modeling approach. Section IV presents the experimental results and performance comparisons. 
Finally, Section V discusses the implications, limitations, and potential for future integration with real-time rehabilitation systems.
