...
merge_data('', 'Data/Stroke/Patient_1/LeftShank-Accelerometer.csv', 'Data/Stroke/Patient_1/RightShank-Accelerometer.csv', 'accelerometer')
merge_data('', 'Data/Stroke/Patient_1/LeftShank-Gyroscope.csv', 'Data/Stroke/Patient_1/RightShank-Gyroscope.csv', 'gyroscope')
...
# Generate the rolling windows again
rolling_windows = generate_rolling_windows(gyro_df, accel_df, window_sec=2.0, stride_sec=1.0, fs=100)

# Output structure of the first window for confirmation
rolling_windows[0]["window_id"], rolling_windows[0]["start_time"], rolling_windows[0]["end_time"], rolling_windows[0]["gyro_left"].shape